window.CONCEPT_SEASONAL_CONFIG = Object.freeze({
  ...
  subbrand: 'Seasonal coffee selection',
  verifiedAt: '6. 8. 2026',
  shopUrl: 'https://www.conceptcoffee.sk/kava/',
  contactUrl: 'https://www.conceptcoffee.sk/kontakty/',
  email: 'shop@conceptcoffee.sk',
  phone: '+421949205711',
  welcome: 'Ahoj. Pomôžem ti preložiť aktuálnu sezónnu ponuku do jednoduchej voľby podľa prípravy a chutí.',
  quick: ['Chcem svieži filter', 'Sladké espresso do mlieka', 'Ovocné, ale nie kyslé', 'Káva bez kofeínu'],
  products: [
    {
      id: 'weithaga',
      name: 'Weithaga AA',
      ...
      availability: 'Skladom viac ako 5 ks pri overení',
    ...
    },
    {
      ...
      country: 'Kolumbia',
      region: 'sezónny lot',
      process: 'výrazné spracovanie',
      altitude: 'podľa aktuálneho lotu',
      score: 'výberová káva',
      prep: ['filter', 'lever'],
      taste: ['fruity', 'strong'],
      drink: ['black'],
    ...
    {
      id: 'holyshot',
      name: 'Holysh*t! espresso',
      country: 'espresso blend',
      region: 'signature Concept',
      process: 'blend',
      altitude: 'kombinovaný pôvod',
      score: 'signature espresso',
      prep: ['automatic', 'lever', 'moka'],
      taste: ['chocolate', 'balanced', 'strong'],
    ...
    {
      id: 'yellow-sunset',
      name: 'Yellow Sunset decaf',
      country: 'bezkofeínová káva',
      region: 'seasonal decaf',
      process: 'decaf',
      altitude: 'podľa aktuálneho lotu',
      score: 'výberová bez kofeínu',
