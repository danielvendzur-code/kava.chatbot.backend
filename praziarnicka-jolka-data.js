...
window.JOLKA = (() => {
  ...
  const demo = {
    ...
    logoInk:'/brand/praziarnicka-logo-official.png', logoBadge:'/brand/praziarnicka-mark.svg', logoHeader:'/brand/praziarnicka-mark.svg', logoAvatar:'/brand/praziarnicka-mark.svg',
