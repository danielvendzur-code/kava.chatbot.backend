(() => {
  ...
  const semanticPhotos = {
    dry:'/assets/cosmetics/choice-dry.png',
    oily:'/assets/cosmetics/choice-hydrate.jpg',
    sensitive:'/assets/cosmetics/two.png',
    balanced:'/assets/cosmetics/choice-balanced.png',
    hydrate:'/assets/cosmetics/choice-hydrate.jpg',
    calm:'/assets/cosmetics/choice-calm.jpg',
    clarity:'/assets/cosmetics/choice-balanced.png',
    mature:'/assets/cosmetics/choice-mature.png',
    simple:'/assets/cosmetics/choice-calm.jpg',
    basic:'/assets/cosmetics/choice-dry.png',
    full:'/assets/cosmetics/choice-balanced.png',
    target:'/assets/cosmetics/choice-hydrate.jpg',
    cream:'/assets/cosmetics/choice-dry.png',
    serum:'/assets/cosmetics/choice-calm.jpg',
    oil:'/assets/cosmetics/choice-hydrate.jpg',
    any:'/assets/cosmetics/choice-balanced.png'
  };
  ...
  const brands = {
    mylo: {
      ...
      hero:'/assets/cosmetics/mylo.jpg',
    ...
    ponio: {
      ...
      hero:'/assets/cosmetics/ponio.png',
    ...
    bellcoria: {
      ...
      hero:'/assets/cosmetics/bellcoria.jpg',
