...
const DEMOS = {
  ...
  anemone:{brand:'ANEMONE',web:'https://anemone.sk/',products:['Pleťový olej na zrelú pleť','Pleťový olej na normálnu & suchú pleť','Pleťový olej na mastnú & problematickú pleť','Kvetinová voda Harmanček'],fallback:{dry:'Pri suchej pleti je jasný smer Pleťový olej na normálnu & suchú pleť. Výber ešte zohľadní, či chcete iba jeden doplnok alebo širšiu rutinu.',oily:'Pri mastnejšej alebo problematickej pleti sa pozrite na Pleťový olej na mastnú & problematickú pleť. Krátky výber ešte spresní prioritu.',sensitive:'Ak chcete rutinu iba jemne doplniť, pozrite Kvetinová voda Harmanček. Pri výrazne reaktívnej pokožke je vhodné výber kozmetiky konzultovať s odborníkom.',mature:'Pre zrelšiu pleť je priamy smer Pleťový olej na zrelú pleť. Výber starostlivosti ešte zohľadní preferovanú rutinu.',default:'ANEMONE má viac jednoduchých olejových a doplnkových produktov. Výber starostlivosti pomôže rozhodnúť podľa typu pleti a priority.'}}
};
